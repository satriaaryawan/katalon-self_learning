...
//Call test case
WebUI.callTestCase(findTestCase('TC_OTP-Page_2'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Courier'), 30, FailureHandling.CONTINUE_ON_FAILURE)
